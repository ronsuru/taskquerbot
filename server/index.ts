...
(async () => {
  ...
  // Initialize Telegram Bot (disabled to avoid conflicts)
  // The bot will run separately using: npm run bot
  log("Telegram bot disabled in main server (run 'npm run bot' separately)");
